...
//JobInfoDataGate* JobInfoDataGate::m_jobInfoDataGate = nullptr;
...
/*
JobInfoDataGate *JobInfoDataGate::getInstance(const QString &dbUserName, const QString &dbPassword)
{
    if(m_jobInfoDataGate == nullptr){
        qDebug()<< "Singleton JobInfoDataGate successful initialization";
        m_jobInfoDataGate = new JobInfoDataGate(dbUserName, dbPassword);
    }
    return m_jobInfoDataGate;
}*/
