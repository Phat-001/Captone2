...
Rectangle {
    width: 412
    height: 846
    id: editDatePickerOverlay
    color: "black"
    visible: false

    property int jobID

    function setProperty(_jobID, _startHour, _startMinute, _finishHour, _finishMinite, _note){
        jobID = _jobID
        startHourTextField.text = _startHour
        startMinuteTextField.text = _startMinute
        finishHourTextField.text = _finishHour
        finishMinuteTextField.text = _finishMinite
        noteTextArea.text = _note
    }
    ...
    Text {
        text: "Edit your job's interview schedule"
        color: "green"
        font.pointSize: 15
        font.italic: true
        x: 20
    ...
    Row {
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onReleased: {
                    ...
                    editDatePickerOverlay.visible = false
                }
            }
        }
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                anchors.fill: parent
                onClicked: {
                    wishJobDataGate.cancelSchedule(jobID)
                    editDatePickerOverlay.visible = false
                }
            }
        }
